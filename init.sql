...
(
    ...
    idStudent            INTEGER REFERENCES pae.users (idStudent)                             NOT NULL,
...
INSERT INTO pae.contacts (idCompany, idStudent, state, academicYear)
VALUES (1, 2, 'initié', '2023-2024');
INSERT INTO pae.contacts (idCompany, idStudent, state, academicYear)
VALUES (2, 2, 'pris', '2023-2024');